...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        x = meas.sensor.sens_to_veh * np.matrix([meas.z[0],meas.z[1],meas.z[2],1]).transpose()
        self.x = np.matrix([[x[0]] , [x[1]],[x[2]],[0.],[0.],[0.]])
...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        print("unassigned tracks",unassigned_tracks)
        b = [n.id for n in self.track_list] 
        print("track list",b)
        #cnt = 0
        pseudo_track_list = self.track_list.copy() 
        for i in unassigned_tracks:
            #i = i -cnt
            track = pseudo_track_list[i]
            # check visibility    
